          ...
          child: Column(
            ...
            children: [
              ...
              Obx(() => CustomImageMulForm(
                ...
                firstImagePath:
                controller.inspectionData['Structural.form1_مخطط']?['path'],
                secondImagePath:
                controller.inspectionData['Structural.form1_منفذ']?['path'],
                onPickFirstImage: () =>
                    ...
                    ...forms.asMap().entries.map((entry) {
                      ...
                      return Padding(
                        ...
                        child: CustomImageMulFormWithInputForm(
                          ...
                          firstImagePath: formData['image1']?['path'],
                          secondImagePath: formData['image2']?['path'],
