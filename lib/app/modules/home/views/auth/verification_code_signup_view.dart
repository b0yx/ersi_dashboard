...
//
//
// class VerificationCodeSignupView extends GetView<VerificationCodeSignupControllerImp> {
//   VerificationCodeSignupView({super.key});
//
//
...
//                 // GetBuilder<VerificationCodeSignupControllerImp>(
//                 //   builder: (controller) {
//                 //     if (controller.statuesRequest == StatusRequest.loading) {
//                 //       return const Center(
//                 //         child: HandlingDataView(
//                 //           statusRequest: StatusRequest.loading,
//                 //           widget: CircularProgressIndicator(), // مؤشر تحميل
//                 //         ),
//                 //       );
//                 //     } else {
//                 //       return
              ...
              children: [
                ...
                Center(
                  child: customTextButton.textButton(
                    label: 'لم يصلني أي رمز تأكيد - إعادة الارسال',
                    onPressed: () {
                      // يمكنك إضافة دالة إعادة إرسال هنا
                    },
                  ),
                ),
                SizedBox(height: screenHeight * 0.03),
